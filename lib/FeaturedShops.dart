...
import 'package:flutterapp/CardViewNavigator.dart';
import 'dart:async';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        List<CardViewNavigator> messageBubbles = [];

        snapshot.data.docs.reversed.forEach((element) {
          print("jfkhhgkhdbjhfb  "+element.id);
          try {
            final messagebubble = CardViewNavigator(
              id: element.id,
              shopName: element.get(shopName).toString(),
